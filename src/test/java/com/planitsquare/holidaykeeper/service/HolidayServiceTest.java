...
class HolidayServiceTest {
	...
	void refreshHolidays_upsert() {
		...
		Country korea = Country.of("KR", "South Korea");
		Holiday existing = Holiday.of(korea, LocalDate.of(2025, 1, 1), "구정", "New Year's Day", true, true, null, null,
			"Public");
		...
		List<HolidayResponse> apiHolidays = List.of(
			new HolidayResponse(LocalDate.of(2025, 1, 1), "신정", "New Year's Day", "KR", true, true, null, null,
				List.of("Public")),
			new HolidayResponse(LocalDate.of(2025, 3, 1), "삼일절", "Independence Movement Day", "KR", true, true, null,
				null, List.of("Public"))
		);
